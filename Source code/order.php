                            ...
                            <fieldset class="form-group">
							    <legend class="mb-3">3. Would you like to specify some design or functional features?<br/></legend>
                                          ...
                                          <input type="text" class="form-control" name="spec" /></br>
                                           If you don't have your own idea - <strong>don't be worried</strong>. We will prepare the best-fitting website's project we can for you!
							    <div style="height: 23px;"></div>
						    </fieldset>
        ...
        <div class="row mt-2">
                ...
                <div class="col-md-8">
                            <fieldset class="form-group">
							    ...
							    We are preparing the website, but you will also need a <strong>hosting</strong> (server) and <strong>domain</strong> (address) to place it on the Internet. If you would like, we can find the best offer for you and <strong>after you will accept it</strong> - publish the website.<br/><br/>
